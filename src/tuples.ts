...
// 1, 'Mirva'
let user: [number, string] = [1, 'Mirva']; // this is how we can annotate a tuple in TS. we are saying that this is a tuple of a number and a string. now if we try to add a boolean to this tuple, we will get an error because it is not a number or a string
