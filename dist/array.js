...
// sooooo
let numbers = [1, 2, 3]; // this is how we can annotate an array in TS. we are saying that this is an array of numbers. now if we try to add a string to this array, we will get an error because it is not a number
...
//the above works
// but if we had this
let array2 = []; // this is an empty array but we are annotating it as an array of numbers. so now if we try to add a string to this array, we will get an error because it is not a number
array2[0] = 1;
